          ...
          <div className="banner-info">
            ...
            <div className="banner-footer">
              <div className="footer-icons">
                <img src="https://img.freepik.com/premium-vector/black-eco-friendly-icon-with-v-shaped-leaves-5-white-background_95164-12265.jpg" alt="eco-icon" />
                <p>Eco-Frinedly</p>
              </div>
              <div className="footer-icons">
                <img src="https://www.shutterstock.com/image-vector/spoon-fork-icon-symbol-vector-260nw-1673884297.jpg" alt="diet-icon" />
                <p>Dietary Preferences</p>
              </div>
              <div className="footer-icons">
                <img src="https://www.shutterstock.com/image-vector/24-hours-7-days-week-260nw-1426474208.jpg" alt="247-icon"/>
                <p>24/7 Support</p>
              </div>
            </div>
          </div>
