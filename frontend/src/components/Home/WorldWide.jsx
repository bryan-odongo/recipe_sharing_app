      ...
      <div className="relative z-20 max-w-4xl xl:max-w-[73rem] w-full h-[98vh]">
        ...
        <div className="relative w-full h-full xl:h-full grid gap-12 grid-cols-7 grid-rows-5">
          <svg
            ...
            className="absolute z-30 left-[59%] top-24"
          >
            <path
              ...
              fill="transparent"
            />
            <polygon points="185,155 195,150 185,145" fill="black" />
            <circle cx="10" cy="150" r="5" fill="black" />
          </svg>
          ...
          <svg
            ...
            height="200"
            xmlns="http://www.w3.org/2000/svg"
            className="absolute z-30 left-[33%] top-12 -rotate-[125deg]"
          >
            <path
              d="M10 150 Q 50 50, 100 150 T 190 150"
              stroke="black"
          ...
          <svg
            ...
            height="200"
            xmlns="http://www.w3.org/2000/svg"
            className="absolute z-30 left-[23%] bottom-28 -rotate-[170deg]"
          >
            <path
              d="M10 150 Q 50 50, 100 150 T 190 150"
              stroke="black"
          ...
          <svg
            ...
            height="200"
            xmlns="http://www.w3.org/2000/svg"
            className="absolute z-30 left-[62%] bottom-56 -rotate-[300deg]"
          >
            <path
              d="M10 150 Q 50 50, 100 150 T 190 150"
              stroke="black"
          ...
          <div className="card -translate-x-10 relative z-10 w-full h-full row-start-3 col-start-6 col-span-2 row-span-2 bg-red-50 overflow-hidden">
            {" "}
            <img
          ...
          <span className="h-12 flex w-[2px] bg-blue-950 absolute bottom-36 left-1/2 -translate-x-1/2" />
          {/* <div className="card w-full h-full col-start-3 row-start-5 col-span-2 row-span-2 bg-red-50 overflow-hidden">
            {" "}
            <img
              src="https://img.freepik.com/free-photo/grilled-chicken-steak-vegetables-marble-background_1150-45265.jpg?t=st=1722959149~exp=1722962749~hmac=7eb91037192790324945595e20092d57a7eb613774e5897bb92e8e0fb9eee9f9&w=360"
              alt="recipe"
              className="rounded-lg h-[65%] w-full"
            />
            <div className="w-full h-fit px-2">
          ...
          <Link
            to={"/recipes"}
            className="absolute bottom-24 left-1/2 -translate-x-1/2 text-white bg-green-600 py-2.5 px-6 rounded-lg text-2xl font-bold uppercase"
          >
            Checkout all our recipes
          </Link>
          {/*<div className="card w-full h-full col-span-2 row-span-2 bg-red-300 overflow-hidden"></div>
          <div className="card w-full h-full col-span-2 row-span-2 bg-red-300 overflow-hidden"></div> */}

          <video
            className="videoPlayer rounded-full absolute top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2 w-[22rem] h-[22rem]  xl:w-[25rem] xl:h-[25rem] object-cover border-red-600"
            // poster={img1}
            // ref={videoRef}
            autoPlay
            loop
